...
def build_flex_leaderboard(growth_list, now_tw):
    COLOR_HEADER = "#0F6E56"
    COLOR_BADGE_BG = "#E1F5EE"
    COLOR_BADGE_TEXT = "#085041"
    COLOR_PCT = "#0a5c42"
    COLOR_RANK = "#888888"
    COLOR_NAME = "#222222"
    COLOR_SUB = "#0F6E56"
    ...
    for i, item in enumerate(growth_list):
        ...
        rows.append({
            ...
            "layout": "horizontal",
            "contents": [
                {"type": "text", "text": RANK_EMOJI[i], "size": "sm", "color": COLOR_RANK, "flex": 1},
            ...
            "contents": [
                {
                    ...
                    "layout": "baseline",
                    "contents": [
                        {"type": "text", "text": "📊 漲幅排行", "size": "xs", "weight": "bold", "color": COLOR_BADGE_TEXT}
                    ],
                ...
                {"type": "text", "text": date_str, "size": "xs", "color": "#9FE1CB", "align": "end", "flex": 1},
            ]
        },
        "body": {
            "type": "box",
