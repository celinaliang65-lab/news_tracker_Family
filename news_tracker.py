...
def build_flex_leaderboard(growth_list, now_tw):
    COLOR_HEADER = "#6b6650"   # 大地棕（偏亮）
    COLOR_TITLE  = "#f5f2ec"   # 標題文字
    COLOR_SUB    = "#d8d4c0"   # 副標題
    COLOR_DATE   = "#f5f2ec"   # 日期
    COLOR_PCT    = "#4a4432"   # 百分比
    COLOR_RANK   = "#bbbb99"   # 圈號
    COLOR_NAME   = "#333333"   # 股票名稱
    COLOR_FOOT   = "#7a7460"   # footer
    COLOR_NOTE   = "#7a7460"   # 符號說明
    COLOR_DIV    = "#ddd8cc"   # 分隔線
